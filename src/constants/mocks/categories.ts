...
export const categoryMocks: CategoryInterface[] = [
  ...
  },
  {
    _id: '2',
    name: 'Languages',
    appearance: { icon: 'Photo', color: '#2196F3' },
  ...
  },
  {
    _id: '3',
    name: 'Science',
    appearance: { icon: 'HelpOutline', color: '#FF9800' },
  ...
  },
  {
    _id: '4',
    name: 'Art',
    appearance: { icon: 'HelpOutline', color: '#E91E63' },
  ...
  },
  {
    _id: '6',
    name: 'Music',
    appearance: { icon: 'Grid3x3', color: '#FFC107' },
  ...
  },
  {
    _id: '7',
    name: 'History',
    appearance: { icon: 'Grid3x3', color: '#795548' },
  ...
  },
  {
    _id: '8',
    name: 'Sports',
    appearance: { icon: 'Grid3x3', color: '#00BCD4' },
  ...
  },
  {
    _id: '9',
    name: 'Design',
    appearance: { icon: 'Photo', color: '#FF5722' },
  ...
  },
  {
    _id: '10',
    name: 'Business',
    appearance: { icon: 'Grid3x3', color: '#3F51B5' },
